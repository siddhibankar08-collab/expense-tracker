  ...
  return (
    <div className="min-h-screen bg-[#0A0A0C] text-neutral-100 font-sans antialiased flex">
      ...
      <aside className="hidden lg:flex w-64 bg-gradient-to-br from-[#1C1C1E] via-[#121214] to-[#0A0A0C] flex-col fixed h-full border-r border-neutral-800 shadow-xl z-20">
        ...
        {/* Dynamic Sidebar Navigation Mapping */}
      ...
      <main className="flex-1 lg:ml-64 min-h-screen flex flex-col">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 pl-1">
                ...
                <div className="hidden md:block text-left">
                  <p className="text-xs font-semibold text-neutral-200 leading-tight">{user?.name || "User"}</p>
        ...
        <div className="p-8 max-w-7xl w-full mx-auto space-y-6 flex-1">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-[#1C1C1E] via-[#121214] to-[#0A0A0C] rounded-2xl p-8 shadow-xl border border-neutral-800 text-white">
            ...
            <h2 className="text-4xl font-black tracking-tight mb-2">₹{balance.toLocaleString("en-IN")}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-[#121214] rounded-2xl p-5 border border-neutral-800 shadow-sm relative overflow-hidden group hover:border-neutral-700 transition-all">
              ...
              <div className="mt-2 w-full bg-neutral-800 h-1.5 rounded-full overflow-hidden">
                <div className="bg-neutral-700 h-full rounded-full" style={{ width: `${savingsRate}%` }}></div>
              </div>
              <p className="text-neutral-500 text-[11px] font-medium mt-1.5">0% Savings rate achieved</p>
            </div>
          </div>
                      ...
                      >
                        <div className="flex items-center gap-3.5">
                          <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${
                            ...
                            {isIncome ? <ArrowDownRight size={18} className="rotate-180" /> : <Receipt size={18} />}
                          </div>
                          <div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-[#121214] w-full max-w-md rounded-2xl shadow-2xl border border-neutral-800 overflow-hidden">
            <div className="px-6 py-4 bg-[#1C1C1E] border-b border-neutral-800 flex justify-between items-center">
              ...
              <button onClick={() => setShowTransactionModal(false)} className="p-1.5 hover:bg-neutral-800 rounded-lg text-neutral-500 hover:text-neutral-300">
                <X size={16} />
              </button>
            </div>
            <form className="p-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-2">Transaction Type</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-2">Amount (INR)</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 font-medium text-sm">₹</span>
                  <input type="number" placeholder="0.00" className="w-full bg-[#1C1C1E] border border-neutral-800 rounded-xl pl-8 pr-4 py-2.5 text-sm font-semibold outline-none text-white placeholder-neutral-600" />
                </div>
              </div>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-2">Date</label>
                <input type="date" className="w-full bg-[#1C1C1E] border border-neutral-800 rounded-xl px-4 py-2.5 text-sm font-medium outline-none text-neutral-200" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-2">Notes</label>
                <textarea rows={2.5} placeholder="What was this item or event for?..." className="w-full bg-[#1C1C1E] border border-neutral-800 rounded-xl px-4 py-2.5 text-sm outline-none resize-none text-neutral-200 placeholder-neutral-600" />
              </div>
              <button type="submit" className={`w-full py-3 rounded-xl font-semibold text-xs uppercase tracking-wider text-white shadow-md ${transactionType === "Expense" ? "bg-rose-600 hover:bg-rose-700" : "bg-emerald-600 hover:bg-emerald-700"}`}>
