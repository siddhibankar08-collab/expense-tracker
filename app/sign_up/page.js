            ...
            <form className="space-y-4" onSubmit={handleSignUp}>
              ...
              <div className="flex items-start gap-3 pt-1">
                ...
                <p className="text-[11px] font-medium text-neutral-500 leading-snug">
                  I confirm acceptance of the <span className="text-white underline cursor-pointer">Terms of Service</span> and the global <span className="text-white underline cursor-pointer">Privacy Policy</span>.
                </p>
              </div>
