    ...
    <div className="bg-[#D8EBFA] min-h-screen font-sans antialiased">
      ...
      <header className="relative bg-gradient-to-r from-[#09264F] via-[#0C336A] to-[#09264F] w-full h-27 px-6 md:px-12 py-3 flex items-center justify-between shadow-2xl border-b border-white/10">
        ...
        <div className="flex items-center gap-4 relative z-10">
          {/* Logo Container - Slimmer padding */}
      ...
      <main className="flex flex-col items-center mt-20 px-4">
        ...
        <div className="bg-[#A2D5FB] px-8 py-2 rounded-[20px] shadow-sm">
          <p className="text-lg font-medium text-[#0C336A]">
            Personal. Multishop. Simple.
          </p>
        </div>

        <h1 className="text-4xl md:text-5xl font-extrabold mt-6 text-center text-slate-900 leading-tight">
          Track every dollar across your
        </h1>

        <h1 className="text-4xl md:text-5xl font-extrabold text-[#052E67] mt-2 text-center leading-tight">
          Life and Shops.
        </h1>

        <p className="text-center text-lg md:text-xl mt-8 font-light max-w-2xl text-slate-800 leading-relaxed">
          Clean dashboards for your personal expenses and as many shops as
          you run. No setup, no clutter — just clarity.
        </p>

        <Link href="/login">
          <button className="mt-8 bg-[#0C336A] text-white px-10 py-3 rounded-xl font-bold shadow-lg hover:bg-[#052E67] transition-all duration-200 transform active:scale-95">
            Get Started →
          </button>
        </Link>
      ...
      <div className="bg-white mt-15">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Card 1 */}
            <div className="group bg-white border border-gray-200 rounded-2xl p-8 shadow-md hover:bg-[#0C336A] hover:shadow-2xl transition-all duration-300 cursor-pointer">
